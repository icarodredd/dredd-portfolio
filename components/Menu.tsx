...
import quotes from "@/public/quotesmd.jpeg";
  ...
  return (
    <main className="mt-20">
      ...
      <p className="text-lg text-white mt-4 light">
        Hey, this website tells a little story about me, professionally. You can check out a few projects and my social
        media.
      </p>
      <p className="text-lg text-white mt-4">{"You'll also find some random pictures that just make sense."}</p>
        ...
        <div className="outline outline-1 outline-offset-2 outline-gray-600 rounded-lg">
          <div>
            <Image
              src={quotes}
              width={500}
              alt="Image of the quotes project"
            />
          </div>
          <a href="https://quotes-md.vercel.app/">
            <Button
